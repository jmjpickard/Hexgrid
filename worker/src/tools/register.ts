...
import { z } from 'zod'
import type { Env, Domain, RegisterHexOutput } from '../lib/types'
...
export type RegisterHexInput = z.infer<typeof registerHexSchema>
...
export async function registerHex(
  ...
  // After isValidDomain narrows to Domain
